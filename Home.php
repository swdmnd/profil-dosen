          ...
          $this->Akun_model->setPekerjaan($post_data);
            ...
            $this->Akun_model->setPenghargaan($post_data);
					...
					if (!empty($_FILES['rps_mk']['name'])) {
						...
						{
								$post_data['rps_mk'] = $work_dir . $config['file_name'] . $this->upload->data('file_ext');
					...
					if (!empty($_FILES['kontrak_mk']['name'])) {
							...
							{
									$post_data['kontrak_mk'] = $work_dir . $config['file_name'] . $this->upload->data('file_ext');
							}
					...
					if (!empty($_FILES['silabus_mk']['name'])) {
						...
						{
								$post_data['silabus_mk'] = $work_dir . $config['file_name'] . $this->upload->data('file_ext');
						}
				}
