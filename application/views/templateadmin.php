        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php if(isset($uid)) {echo site_url(). '/getfile/profileImageAdmin/true/' . $uid;} else {echo '';}?>" class="user-image" alt="User Image">

              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><?= $identitas->nama ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <!--<img src="<?= base_url() . $identitas->foto; ?>" class="img-circle" alt="User Image">-->
                <img src="<?php if(isset($uid)) {echo site_url(). '/getfile/profileImageAdmin/true/'. $uid;} else {echo '';}?>" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p style="color:white;"><?= wordwrap($identitas->nama, 40, "<br />\n"); ?></p>
          <!-- Status -->
