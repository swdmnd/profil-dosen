...
<div class="main-header">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <h1 style="font-size:18px;text-transform:capitalize;margin-bottom:-10px">Pengabdian Masyarakat</h1>
              </div>
                <?php
                    if(empty($pengabdian)) echo '<h4>-</h4>';
                    $a = 0;
                ...
                ?>
                <div class="hgroup" >
                  <h4 style="color:#515151;font-size:18px;text-align:justify;font-family:candara, sans-serif;line-height: 100%;text-transform:capitalize;"><?= $item->tahun_mulai?></h4>
                </div>
                ...
                Sumber Dana : <?= $item->sumber_dana ?>.</li>
                </p>
              <?php } else { ?>
              <?php
                $a = $item->tahun_mulai; ?>
