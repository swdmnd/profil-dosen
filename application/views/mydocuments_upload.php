<div class="panel panel-info">
    <div class="panel-heading">
        <h4><a role="button" class="close" aria-label="Close" href="<?= site_url()."/home/mydocuments/?d=".$this->input->get('d'); ?>"><span aria-hidden="true">&times;</span></a>Upload file ke '<?= $this->input->get('d') ?>'</h4>
    </div>
    ...
    <div class="panel-body">
        ...
        ?>
        <?php echo form_open_multipart(site_url()."/home/mydocuments/upload/?d=".$this->input->get('d'), 'class="form-horizontal"');?>
