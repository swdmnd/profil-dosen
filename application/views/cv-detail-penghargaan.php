...
<div class="main-header">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <h1 style="font-size:18px;text-transform:capitalize;margin-bottom:-10px">Penghargaan</h1>
              </div>
                <?php
                    if(empty($penghargaan)) echo '<h4>-</h4>';
                    $a = 0;
                ...
                ?>
                <div class="hgroup" >
                  <h4 style="color:#515151;font-size:18px;text-align:justify;font-family:candara, sans-serif;line-height: 100%;text-transform:capitalize;"><?= $item->tahun_penghargaan?></h4>
                </div>
                <h4 style="color:#515151;text-align:justify;font-family:candara, sans-serif;line-height: 100%;text-transform:capitalize;"><li>Pada tahun <?= $item->tahun_penghargaan?> sebagai <?= $item->sebagai ?> pada <?= $item->nama_penghargaan?> dari <?= $item->pemberi_penghargaan ?>
                </h4></li>
              <?php } else { ?>
              <?php
                $a = $item->tahun_penghargaan; ?>
