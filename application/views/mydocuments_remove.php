...
<div class="panel panel-danger">
    <div class="panel-heading">
        <h4><a role="button" class="close" aria-label="Close" href="<?= site_url()."/home/mydocuments/?d=".$this->input->get('d'); ?>"><span aria-hidden="true">&times;</span></a>Peringatan</h4>
    </div>
    ...
    <div class="panel-body">
        ...
        <form method="post" action="<?= site_url()."/home/mydocuments/remove/d=".$this->input->get('d'); ?>">
