...
<div class="panel panel-info">
    <div class="panel-heading">
        <h4><a role="button" class="close" aria-label="Close" href="<?= site_url()."/home/mydocumentsadmin/?d=".$this->input->get('d').($this->input->get("sd") ? "&sd=".$this->input->get("sd")."&id=".$this->input->get("id"):""); ?>"><span aria-hidden="true">&times;</span></a>Ubah nama <?= $this->input->get("type").' \'<b>'.$this->input->get("old_name").'</b>\'' ?></h4>
    </div>
    ...
    <div class="panel-body">
        ...
        ?>
        <?= form_open(site_url()."/home/mydocumentsadmin/rename/?d=".$this->input->get('d').($this->input->get("sd") ? "&sd=".$this->input->get("sd")."&id=".$this->input->get("id"):""), 'class="form-horizontal"'); ?>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a role="button" class="btn btn-danger" href="<?= site_url()."/home/mydocumentsadmin/?d=".$this->input->get('d').($this->input->get("sd") ? "&sd=".$this->input->get("sd")."&id=".$this->input->get("id"):""); ?>">Batalkan</a>
                </div>
            </div>
        <?= form_close(); ?>
    </div>
