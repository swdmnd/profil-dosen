<div class="panel panel-default" id="identitas">
    ...
    <div class="panel-body">
        ...
        <table id="dosenlist" class="table table-bordered table-hover table-striped">
            <thead>
              <tr>
                <th>No.</th>
                <th>NIK (Username)</th>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="editId" name="id">
          <div class="form-group">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="editNIK" name="nik" placeholder="NIK sebagai username" />
              </div>
          </div>
          <div class="form-group">
...
//$(".btn-edit").click(function(){
  $("#dosenlist").on("click", ".btn-edit", function() {
